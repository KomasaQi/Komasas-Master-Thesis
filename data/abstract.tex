...
First, a scenario-oriented model- and simulation-based systems engineering method is proposed, and the vehicle-cloud collaborative tanker truck anti-rollover mission architecture is established. The proposed method develops a four-stage architecture modeling and closed-loop verification process, namely strategy, operation, service, and resource, and provides unified system boundaries, time-scale constraints, and interface organization for subsequent cloud-side predictive decision-making, vehicle-side local planning, and high-frequency control.
