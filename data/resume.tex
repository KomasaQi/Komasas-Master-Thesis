...
\begin{resume}
  ...
  \begin{achievements}
    ...
    \item Zhong W, Gong L, \textbf{Qi X}, Wang K, Li B. Robust Semi-Trailer Trajectory Tracking with Extended-State Observer[C].IFAC, 2026.(in press 已被IFAC录用).
  \end{achievements}
  ...
  \begin{achievements}
    ...
    \item 钟薇, \textbf{戚笑景},何瑞坤,龚林豪,王坤鹏,肖壮锐,高博麟.液罐车横纵向耦合自适应防侧翻轨迹跟踪控制方法、系统：中国,[P]. （专利申请号）.
    \item 钟薇, 龚林豪,\textbf{戚笑景},王坤鹏,李波.一种半挂车轨迹跟踪横向控制方法：中国,[P]. （专利申请号）.
